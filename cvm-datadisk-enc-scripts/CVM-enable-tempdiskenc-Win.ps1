#
# This script can be used to turn on temp disk encryption (TDE) feature in an existing Azure Windows confidential VM.
...
$pubSettings.Add("EncryptionOperation", "EnableEncryption")
