...
namespace AttestationClientLibTest {
    ...
    */
    ...
    TEST_F(ClientLibTests, TestGetReportTypeWithEmptyReport) {
        const std::vector<unsigned char> empty_report;

        ReportType actual = hcl_report_parser->GetReportType(empty_report);

        EXPECT_TRUE(actual == ReportType::UNDEFINED);
    }

    TEST_F(ClientLibTests, TestGetReportTypeWithCorruptedReport) {
        const std::string corrupted_report =
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAKcCAAABAAAABAAAAAEAAACTAgAAeyJrZXlzIjpbeyJraWQiOiJIQ0xUcmFu"
            "c2ZlcktleSIsImtleV9vcHMiOlsiZW5jcnlwdCJdLCJrdHkiOiJSU0EiLCJlIjoiQVFBQiIsIm4iOiI4"
            "REZILXRkZEIxUmJSdWl1MHNiWE5xQ0pSNDJaT3hhRS1YMDJoV1FTRVhNdEdtakhLSldqMHpna0RLVGdG"
            "ai1MNV9mQ1ZOTGJVeXhxSVotNUpLMzhMZldzMk4tclZXUzN3Rm1YUDF4Z1hBTjNUUW0ta0hiMkxCVnVZ"
            "YTcwV0NFejc1d25xYXhuRlhKVDJJbUtHejQzSDVlSnZ2TUtQMEtYdlFIYk84SW53SEVKZXE1MUo1cTNT"
            "bGtEOGYtQmQ0dDFsXzRLRXNlQTZiejJjT3lMOTBDcFF1TnR1QWtWRTlBbGFET0VDWElsbDl5MjRXNmlC"
            "Qy1FU3NBVjNfQi0tZUxqREVKVHZBSEFJckg0bGRYcmljbmNMUmJIZlpDQWFQbkhlMGhYSTBSbXNSVWR1"
            "SjllSk02emJNM3RGQXp2aFVual9zalBqa0dIb3VQYmxRV1VEMUVYeVEifV0sInZtLWNvbmZpZ3VyYXRp"
            "b24iOnsiY29uc29sZS1lbmFibGVkIjpmYWxzZSwiY3VycmVudC10aW1lIjoxNjg4NzY3MDY2LCJyb290"
            "LWNlcnQtdGh1bWJwcmludCI6IjZuWlpuWWFKYzRLcVVaX3l2QS1tdWNGZFlOb3V2bFBuSVRuTk1Yc0hs"
            "LTAiLCJzZWN1cmUtYm9vdCI6dHJ1ZSwidHBtLWVuYWJsZWQiOnRydWUsInZtVW5pcXVlSWQiOiI4MDAy"
            "MzUyRS1CRUE2LTRGMEYtQTk4RC05Q0ZEMkZFQzI4RkEifX0";

        ReportType actual = hcl_report_parser->GetReportType(attest::base64::base64url_to_binary(corrupted_report));

        EXPECT_TRUE(actual == ReportType::UNDEFINED);
    }

    TEST_F(ClientLibTests, TestGetReportType) {
        const std::string hcl_report_base64 =
            "SENMQQIAAABnBwAAAQAAAAAAAAAAAAAAAAAAAAAAAACBAAAAAAAAAAAAAAAAAAAABgYTFQP_AAMAAAAA"
            "AAAAAIgBvmOXvwqzJYp8nrcqc77kxvpOr-HjrDx9BpplLTNFk8seb_SeNH1TjVv6Gciz-dRD6FO323Uc"
            "fvJYmZy1auwU8sWX7d2jFJtNvZbNMjyYZJ5V5fhv8_tBHwIQgh0-QlRD-cybqYFOL5zDi04TBtWLP_TW"
            "lSboz1qckZGUERYgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAmlzHoHnmKG6aD7KMpqRbA16Ul6KHA6NtMwqEc_Jg-P_wEDAAAAAAACAQYA"
            "AAAAAAAAAAAAAAAANgME00oWqs4KGOCa0tB9K5_TwXQ3jlvxCDiAeYJ_if9irMX4xHPdQHBjJINOIClG"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACAQYA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAA5xgGAAAAAADJ6Iwj2dZoDc8avFatRDWWFxOkXu-GUO7axXEvk-xkAq6gjLgpDpTI"
            "CHffGY5WqccAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        ...
        ReportType actual = hcl_report_parser->GetReportType(attest::base64::base64url_to_binary(hcl_report_base64));

        EXPECT_TRUE(actual == ReportType::TDX);
    }

    TEST_F(ClientLibTests, TestExtractTdxReportAndRuntimeDataFromHclReport) {
        const std::string hcl_report_base64 = "SENMQQIAAABnBwAAAQAAAAAAAAAAAAAAAAAAAAAAAACBAAAAAAAAAAAAAAAAAAAABgYTFQP_AAMAAAAA"
            "AAAAAIgBvmOXvwqzJYp8nrcqc77kxvpOr-HjrDx9BpplLTNFk8seb_SeNH1TjVv6Gciz-dRD6FO323Uc"
            "fvJYmZy1auwU8sWX7d2jFJtNvZbNMjyYZJ5V5fhv8_tBHwIQgh0-QlRD-cybqYFOL5zDi04TBtWLP_TW"
            "lSboz1qckZGUERYgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAmlzHoHnmKG6aD7KMpqRbA16Ul6KHA6NtMwqEc_Jg-P_wEDAAAAAAACAQYA"
        ...
        const std::string variable_data_base64 = "eyJrZXlzIjpbeyJraWQiOiJIQ0xUcmFuc2ZlcktleSIsImtleV9vcHMiOlsiZW5jcnlwdCJdLCJrdHki"
            "OiJSU0EiLCJlIjoiQVFBQiIsIm4iOiI4REZILXRkZEIxUmJSdWl1MHNiWE5xQ0pSNDJaT3hhRS1YMDJo"
            "V1FTRVhNdEdtakhLSldqMHpna0RLVGdGai1MNV9mQ1ZOTGJVeXhxSVotNUpLMzhMZldzMk4tclZXUzN3"
            "Rm1YUDF4Z1hBTjNUUW0ta0hiMkxCVnVZYTcwV0NFejc1d25xYXhuRlhKVDJJbUtHejQzSDVlSnZ2TUtQ"
            "MEtYdlFIYk84SW53SEVKZXE1MUo1cTNTbGtEOGYtQmQ0dDFsXzRLRXNlQTZiejJjT3lMOTBDcFF1TnR1"
            "QWtWRTlBbGFET0VDWElsbDl5MjRXNmlCQy1FU3NBVjNfQi0tZUxqREVKVHZBSEFJckg0bGRYcmljbmNM"
            "UmJIZlpDQWFQbkhlMGhYSTBSbXNSVWR1SjllSk02emJNM3RGQXp2aFVual9zalBqa0dIb3VQYmxRV1VE"
            "MUVYeVEifV0sInZtLWNvbmZpZ3VyYXRpb24iOnsiY29uc29sZS1lbmFibGVkIjpmYWxzZSwiY3VycmVu"
            "dC10aW1lIjoxNjg4NzY3MDY2LCJyb290LWNlcnQtdGh1bWJwcmludCI6IjZuWlpuWWFKYzRLcVVaX3l2"
            "QS1tdWNGZFlOb3V2bFBuSVRuTk1Yc0hsLTAiLCJzZWN1cmUtYm9vdCI6dHJ1ZSwidHBtLWVuYWJsZWQi"
            "OnRydWUsInZtVW5pcXVlSWQiOiI4MDAyMzUyRS1CRUE2LTRGMEYtQTk4RC05Q0ZEMkZFQzI4RkEifX0";

        const std::string tdx_report_base64 = "gQAAAAAAAAAAAAAAAAAAAAYGExUD_wADAAAAAAAAAACIAb5jl78KsyWKfJ63KnO-5Mb6Tq_h46w8fQaa"
            "ZS0zRZPLHm_0njR9U41b-hnIs_nUQ-hTt9t1HH7yWJmctWrsFPLFl-3doxSbTb2WzTI8mGSeVeX4b_P7"
            "QR8CEIIdPkJUQ_nMm6mBTi-cw4tOEwbViz_01pUm6M9anJGRlBEWIAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAJpcx6B55ihumg-yjKakWw"
            "NelJeihwOjbTMKhHPyYPj_8BAwAAAAAAAgEGAAAAAAAAAAAAAAAAADYDBNNKFqrOChjgmtLQfSuf08F0"
            "N45b8Qg4gHmCf4n_YqzF-MRz3UBwYySDTiApRgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAgEGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAOcYBgAAAAAAyeiMI9nWaA3PGrxW"
            "rUQ1lhcTpF7vhlDu2sVxL5PsZAKuoIy4KQ6UyAh33xmOVqnHAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        ...
        attest::Buffer runtime_data;
        AttestationResult res = hcl_report_parser->ExtractTdxReportAndRuntimeDataFromHclReport(attest::base64::base64url_to_binary(hcl_report_base64),
            tdx_report,
            runtime_data);

        EXPECT_EQ(res.code_, AttestationResult::ErrorCode::SUCCESS);
        EXPECT_EQ(variable_data_base64, attest::base64::binary_to_base64url(runtime_data));
        EXPECT_EQ(tdx_report_base64, attest::base64::binary_to_base64url(tdx_report));
    }
};
